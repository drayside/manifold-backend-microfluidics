...
( assert ( <= channelC.length 0.1 ) )
( assert ( >= channelD.length 1.0E-4 ) )
( assert ( <= channelD.length 0.1 ) )
( assert ( >= channelE.length 1.0E-4 ) )
( assert ( <= channelE.length 0.1 ) )
...
( assert ( >= out0.input.pressure 0 ) )
( assert ( <= out0.input.pressure 1013250 ) )
( assert ( >= in0.output.pressure 0 ) )
( assert ( <= in0.output.pressure 1013250 ) )
( assert ( = channelC.viscosity 0.01 ) )
( assert ( >= in1.output.pressure 0 ) )
( assert ( <= in1.output.pressure 1013250 ) )
