...
( assert ( <= channelC_length 0.1 ) )
( assert ( >= channelD_length 1.0E-4 ) )
( assert ( <= channelD_length 0.1 ) )
( assert ( >= channelE_length 1.0E-4 ) )
( assert ( <= channelE_length 0.1 ) )
...
( assert ( >= out0_input_pressure 0 ) )
( assert ( <= out0_input_pressure 1013250 ) )
( assert ( >= in0_output_pressure 0 ) )
( assert ( <= in0_output_pressure 1013250 ) )
( assert ( = channelC_viscosity 0.01 ) )
( assert ( >= in1_output_pressure 0 ) )
( assert ( <= in1_output_pressure 1013250 ) )
